...
unsigned int g_InitializationAttempts = 0;
...
void MirvPovFeedback_LogStatus()
{
    advancedfx::Message(
        "[mirv_pov_feedback] status feedback attempts=%u sound=%p hash=%p damageMessage=%p "
        "addDirection=%p damageCtor=%p damageHooked=%d ctorHooked=%d hud=%p\n",
        g_InitializationAttempts,
        reinterpret_cast<void *>(reinterpret_cast<uintptr_t>(g_PlayEntitySound)),
        reinterpret_cast<void *>(reinterpret_cast<uintptr_t>(g_HashString)),
        reinterpret_cast<void *>(reinterpret_cast<uintptr_t>(g_OriginalDamageMessage)),
        reinterpret_cast<void *>(reinterpret_cast<uintptr_t>(g_AddDamageDirection)),
        reinterpret_cast<void *>(reinterpret_cast<uintptr_t>(g_OriginalDamageIndicatorConstructor)),
        g_DamageMessageHooked ? 1 : 0,
        g_DamageIndicatorConstructorHooked ? 1 : 0,
        g_DamageIndicator);
}
